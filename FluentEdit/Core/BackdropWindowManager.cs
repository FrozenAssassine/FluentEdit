...
namespace FluentEdit.Core
{
    ...
    public class BackdropWindowManager
    {
        ...
        public void SetBackdrop(BackgroundType type)
        {
        ...
        bool TrySetAcrylicBackdrop()
        {
            ...
            var color = AppSettings.AcrylicBackground;
        ...
        private void SetStaticBackground(bool clear = false)
        {
            Grid grid;
            ...
            var color = AppSettings.StaticBackground;
            grid.Background = clear ? null : new SolidColorBrush(color);
        }
